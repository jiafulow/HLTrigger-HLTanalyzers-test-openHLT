...
skimL1ETM36ORETM40 = cms.EDFilter("TriggerResultsFilter",
    hltResults            = cms.InputTag(''),                 # HLT results   - set to empty to ignore HLT
    ...
    triggerConditions     = cms.vstring( 'L1_ETM36 OR L1_ETM40' )
    )
