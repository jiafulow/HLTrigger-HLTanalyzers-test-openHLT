...
verbose=True
mprefx="--"
cfgpreamble="#This file has been autogenerated by onlyPAT.py"
...
try: temp=open(oPATconfig_template).read()
except IOError:
    print mprefx,"[!] Error: Cannot find the template file:",oPATconfig_template
    sys.exit()

if verbose: print mprefx, "[i] read the template file:", oPATconfig_template
