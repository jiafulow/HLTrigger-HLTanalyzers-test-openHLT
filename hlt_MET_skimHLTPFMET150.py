...
#process.hltPFTrackMETProducer = cms.EDProducer("HLTTrackMetProducer",
#    inputTrackTag = cms.InputTag( "hltLightPFTracks" ),
#    usePt = cms.bool( True ),
#    etaTrack = cms.double( 9999.0 ),
#    minPtTrack = cms.double( 0.0 )
#)
#process.hltPFTrackMET150Filter = cms.EDFilter("HLTTrackMetFilter",
#    saveTags = cms.bool( True ),
#    minTrackMet = cms.double( 150.0 ),
#    inputTrackMetTag = cms.InputTag( "hltPFTrackMETProducer" )
#)
#process.hltMetCleanByJetID = cms.EDProducer("HLTTPCaloJetsOnCaloJetsMETCleaner",
...
# New
#process.HLT_PFMET150_Changed_TrackMET_v1 = cms.Path(process.HLTBeginSequence+process.hltL1sL1ETM36ORETM40+process.hltPrePFMET150+process.HLTRecoMETSequence+process.hltMET80+process.HLTPFL1FastL2L3ReconstructionSequence+process.hltPFTrackMETProducer+process.hltPFTrackMET150Filter+process.HLTEndSequence)
#process.HLT_PFMET150_Changed_JetIDCleaned_v1 = cms.Path(process.HLTBeginSequence+process.hltL1sL1ETM36ORETM40+process.hltPrePFMET150+process.HLTRecoMETSequence+process.hltMET80+process.HLTPFL1FastL2L3ReconstructionSequence+process.hltMetCleanByJetID+process.HLTEndSequence)
